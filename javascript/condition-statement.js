...
// TODO: if-else 조건문 실습
// 변수 age에 18을 할당한다
// age가 20 이상이면 "성인입니다", 아니면 "미성년자입니다"를 출력한다
// 변수 age를 출력한다
...
let isLoggedIn = true;
console.log(isLoggedIn === true ? "환영합니다" : "로그인이 필요합니다");
...
let age1 = 18;
console.log(age1 >= 20 ? "성인입니다" : "미성년자입니다");
...
let number = -5;
console.log(
  number > 0 ? "양수" : number < 0 ? "음수" : number === 0 ? "0" : ""
);
...
} else console.log("이미 로그인이 되어 있습니다");
...
if (userAge3 >= 21 && hasInsurance && hasLicense) {
  console.log("완벽한 운전자");
} else if (userAge3 >= 21 && hasLicense) {
  console.log("운전 가능");
} else console.log("운전 불가");
